...
export function loadAppearancePreferences(): AppearancePreferences {
  try {
    ...
    return {
      ...
      fontScale: parsed.fontScale === 90 || parsed.fontScale === 110 ? parsed.fontScale : 100,
...
export function applyAppearancePreferences(preferences: AppearancePreferences) {
  ...
  root.style.setProperty("--ui-font-scale", `${preferences.fontScale / 100}`);
}
