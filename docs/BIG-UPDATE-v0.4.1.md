# Ginga 0.4.1 - BIG Update

A 0.4.1 parte diretamente da 0.4.0 e preserva os fixes de Desktop, updater, voz, perfis e personalizacao existentes.
...
As tabelas 0.4.1 sao criadas de maneira aditiva e idempotente pela API. As politicas de seguranca novas iniciam desligadas em servidores existentes para evitar mudanca de comportamento apos o update.
